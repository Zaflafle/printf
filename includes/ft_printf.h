...
/*   Updated: 2018/03/07 04:06:21 by macuguen         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int			ft_instruction_d_i_no(va_list *args, char *format, t_printf *list, char *tmp);
int			ft_instruction_o(va_list *args, char *format, t_printf *list);
int			ft_instruction_o_no(va_list *args, char *format, t_printf *list, char *tmp);
int			ft_instruction_x_no(va_list *args, char *format, t_printf *list, char *tmp);
int			ft_instruction_x(va_list *args, char *format, t_printf *list);
int			ft_instruction_s(va_list *args, char *format, t_printf *list);
int			ft_instruction_s_no(va_list *args, char *format, t_printf *list, char *tmp);
